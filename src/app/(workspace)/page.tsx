...
import { StatCard, FeatureCard, Header } from "@/components/custom" // Header Added
...
export default function DashboardPage() {
  ...
  const [currentRole, setCurrentRole] = useState<'MANAGER'|'STAFF'>('MANAGER') // Role State
  ...
  return (
    <div className="flex flex-col h-full"> 
      ...
      <Header 
        ...
        notificationCount={safeStats.healthAlerts.warning + safeStats.healthAlerts.info}
        userInitial="박"
      >
      ...
      <main className="flex-1 overflow-y-auto p-8 max-w-7xl mx-auto space-y-8 w-full">
